...
namespace Services
{
    public class logica_de_los_servicios
    {
        ...
        public Boolean registrar_un_servicio(Servicios datos_del_servicio, Datos_login datos_de_conexion_actualizada)
        {
            Boolean confirmacion;

            confirmacion = Funciones_De_Los_Servicios.Ingresar_Un_Servicio(datos_de_conexion_actualizada, datos_del_servicio);
        ...
        public Boolean actualizar_un_servicio(Servicios datos_del_servico, Datos_login datos_de_conexion)
        {
            Boolean confirmacion;
        ...
        public Boolean eliminar_un_servicio(Servicios datos_del_servicio, Datos_login datos_de_conexion)
        {
            Boolean confirmacion;
