...
namespace Services
{
    public class logica_de_las_reservaciones
    {
        ...
        public DataTable todas_las_reservaciones(Datos_login datos_de_conexion, Reservacion datos_de_una_reservacion)
        {
            DataTable lista_de_reservaciones;

            lista_de_reservaciones = funciones_De_La_Reservacion.Consultar_Todas_las_reservaciones(datos_de_conexion, datos_de_una_reservacion);
        ...
        public DataTable todas_las_reservaciones_de_una_empresa(Datos_login datos_de_conexion, Reservacion datos_de_una_reservacion)
        {
            ...
            lista_de_reservaciones = funciones_De_La_Reservacion.reservaciones_De_la_empresa(datos_de_conexion, datos_de_una_reservacion);
