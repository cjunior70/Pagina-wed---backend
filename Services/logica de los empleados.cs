...
namespace Services
{
    public class logica_de_los_empleados
    {
        ...
        public Boolean ingresar_un_empleado(Empleado datos_empleado, Datos_login datos_de_conexion)
        {
        ...
        //Funcion para consultar todos los empleados de una empresa
        public DataTable consultar_todos_los_empleados_de_una_empresa(Datos_login datos_de_conexion, Empresa datos_de_la_empresa)
        {
            ...
            datos = funciones_Del_Empleado.Consultar_Empleados_de_una_empresa(datos_de_conexion, datos_de_la_empresa);
        ...
        public DataTable consultar_datos_de_un_empleado(Datos_login datos_de_conexion, Empleado datos_del_empleado)
        {
            DataTable datos=new DataTable();
        ...
        public Boolean actualizar_datos_de_un_empleado(Empleado datos_actualizados, Datos_login datos_de_conexion)
        {
            Boolean confirmacion;
        ...
        public Boolean borrar_un_empleado(Empleado datos_del_empleado, Datos_login datos_de_conexion)
        {
            Boolean confirmacion;
