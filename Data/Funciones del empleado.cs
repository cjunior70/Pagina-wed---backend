...
namespace Data
{
    public class Funciones_del_empleado
    {
        ...
        private void Enviar_Datos(Empleado datos_empleado)
        {
        ...
        public DataTable Consultar_Un_Empleado(Datos_login Conexion_del_Usuario, Empleado datos_del_usuario)
        {
        ...
        private void traer_datos_de_un_empleado(Empleado datos_del_usuario)
        {
